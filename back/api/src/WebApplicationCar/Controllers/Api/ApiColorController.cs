...
namespace WebApplicationCar.Controllers.Api
{
    ...
    public class ApiColorController : ControllerBase
    {
        ...
        public async Task<ActionResult<ColorModel>> PostColorModel(
            [FromBody] ColorModel colorModel, // Убедитесь, что форма отправляет данные с правильными именами
            [FromForm] IFormFile file // Для файла используем [FromForm]
        )
        {
